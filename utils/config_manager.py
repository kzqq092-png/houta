...
class ConfigManager(QObject):
    ...
    logging_config_changed = pyqtSignal(LoggingConfig)  # Signal emitted when logging config changes
    ...
    def __init__(self, config_dir: str = None, config_name: str = "config.json", 
        ...
        if hasattr(self, '_logging'):
            self._logging.config_changed.connect(self._on_logging_config_changed)
