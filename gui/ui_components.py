...
class AnalysisToolsPanel(QWidget):
    ...
    def __init__(self, parent=None):
        """Initialize analysis tools panel"""
        try:
            ...
            self.log_manager = LogManager(LoggingConfig(
                ...
                performance_log_file='analysis_performance.log',
                exception_log=True,
                exception_log_file='analysis_exceptions.log',
                async_logging=True,
                log_queue_size=1000,
                worker_threads=2
            ))
    ...
    def on_analyze(self):
        ...
        try:
            ...
            params = {name: control.value() for name, control in self.param_widgets.items()}
