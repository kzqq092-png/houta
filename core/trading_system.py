...
class TradingSystem:
    ...
    def set_stock(self, stock_code: str):
        ...
        try:
            ...
            log_manager.log(f"设置股票失败: {str(e)}", "error")
    ...
    def load_kdata(self, start_date: Optional[str] = None,
        ...
        try:
            ...
            log_manager.log(f"加载K线数据失败: {str(e)}", "error")
    ...
    def calculate_signals(self, strategy: str = 'MA') -> List[Dict[str, Any]]:
        ...
        try:
            ...
            log_manager.log(f"计算交易信号失败: {str(e)}", "error")
            return []
    ...
    def run_backtest(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            log_manager.log(f"运行回测失败: {str(e)}", "error")
            return {}
    ...
    def get_market_overview(self) -> Dict[str, Any]:
        ...
        try:
            ...
            log_manager.log(f"获取市场概览失败: {str(e)}", "error")
            return {}
    ...
    def get_fund_flow(self) -> Dict[str, Any]:
        ...
        try:
            ...
            log_manager.log(f"获取资金流向失败: {str(e)}", "error")
            return {}
    ...
    def _get_north_flow(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            log_manager.log(f"获取北向资金数据失败: {str(e)}", "error")
            return []
    ...
    def _get_industry_flow(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            log_manager.log(f"获取行业资金流向数据失败: {str(e)}", "error")
            return []
    ...
    def _get_concept_flow(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            log_manager.log(f"获取概念资金流向数据失败: {str(e)}", "error")
            return []
