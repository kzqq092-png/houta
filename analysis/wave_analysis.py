...
import pandas as pd
from hikyuu import Datetime, Query, KData, MA, HT_TRENDLINE
...
class WaveAnalyzer:
    ...
    def analyze_elliott_waves(self, kdata: KData, period: int = 20, 
    ...
    def analyze_gann(self, kdata: KData, period: int = 20, 
                    sensitivity: float = 0.01) -> Dict:
    ...
    def get_wave_signals(self, kdata: KData) -> List[Dict]:
