...
### AI分析
- **AI智能选股**：输入选股需求（如"高ROE低估值"），点击"一键AI选股"，查看并导出结果。
- **AI策略生成**：输入策略描述（如"均线金叉买入"），点击"一键生成并回测"，查看策略代码和回测结果。
- **AI调仓/风控**：填写持仓表、策略、风控参数，点击"一键AI调仓/风控分析"，获取建议。

### AI工具
- **多模态AI分析**：上传图片/表格或输入文本，点击"一键多模态AI分析"，查看分析结果。
- **AI行情解读**：输入新闻/公告文本或URL，点击"一键AI行情解读"，获取解读。
- **AI知识图谱**：输入文本，点击"一键构建知识图谱"，可进行智能问答。
- **智能报告**：输入对象和类型，点击"一键生成报告"，预览并导出。
- **智能预警**：设置预警条件和推送方式，点击"启动智能预警"，查看历史记录。

### AI助手
- **AI助手**：输入问题或需求，点击"发送"，获取AI多轮对话回复。

### 通用操作说明
- 每个功能顶部有"使用步骤"提示，输入区有说明和示例，必填项红色星号，选填项灰色。
- 结果区统一风格，底部有导出/复制按钮。
- 操作中有进度条或"正在分析..."提示，异常弹窗和结果区同步显示。
- 所有界面自适应移动端和小屏幕。

### 示例：AI智能选股
1. 在"AI分析">"AI智能选股"Tab，输入"高ROE低估值"
2. 点击"一键AI选股"
3. 查看结果表格，点击"导出"或"复制"保存
